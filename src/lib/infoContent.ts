...
export const INFO_CONTENT: Record<string, InfoContent> = {
  "section:layers": {
    ...
    summary:
      "These toggles control what is drawn on the map. The analytical layers are best read in combinations, not all at once.",
    sections: [
      {
        heading: "How to use",
      ...
      },
      {
        ...
        body: "Each layer group can add fills, outlines, labels, or markers. Dense combinations can obscure the main search picture, which is why the focus presets exist.",
      },
    ],
  },
  "layer:flightpath": {
    ...
    summary:
      "Shows the accepted early route from departure through the last radar observations, plus inferred continuation where the public record becomes uncertain.",
    sections: [
      {
        heading: "What it means",
        body: "This is the historical baseline, not the final search solution. It explains where the aircraft was known to be before Inmarsat-only reasoning takes over.",
      },
      {
        heading: "Why it matters",
        body: "Use it to understand the transition from radar evidence to BTO/BFO-based search geometry.",
      },
    ],
  },
  "layer:anomalies": {
    ...
    summary:
      "Shows evidence leads that are interesting because they support, contradict, or complicate the current search narrative.",
    sections: [
      {
        heading: "What it shows",
        body: "Hydroacoustic events, satellite interpretations, drift clues, and signal-processing anomalies.",
      },
      {
        heading: "How to read it",
        body: "Click a marker to open the right panel and inspect the claim, confidence, conflicts, and search implications.",
      },
    ],
  },
  "layer:airspaces": {
    ...
    summary:
      "Shows the flight information regions that existed on 8 March 2014, useful for understanding route behavior and possible navigation intent.",
    sections: [
      {
        heading: "Why it matters",
        body: "Some candidate routes interact with FIR edges in ways that can look deliberate rather than random.",
      },
      {
        heading: "What it does not do",
        body: "It does not prove intent by itself; it is a context layer for route interpretation.",
      },
    ],
  },
  "layer:magnetic": {
    ...
    summary:
      "Displays magnetic anomaly structure in the seabed. This helps identify terrain where magnetometer-based search methods could be more or less informative.",
    sections: [
      {
        heading: "Visual meaning",
        body: "High contrast regions indicate stronger magnetic variation in crustal structure.",
      },
      {
  ...
  "layer:arcs": {
    ...
    summary:
      "Each arc is the set of positions consistent with one measured burst timing offset after satellite calibration and geometry are applied.",
    sections: [
      {
        heading: "Core idea",
        body: "BTO constrains range to the satellite, so each handshake becomes a ring rather than a single point.",
      },
  ...
  "layer:heatmap": {
    ...
    sections: [
      ...
      {
        heading: "Best use",
        body: "Use it first, then compare against searched zones, priority gaps, or debris inversion output.",
      },
    ],
  },
  "layer:paths": {
    ...
    summary:
      "These are sampled trajectories that match the BTO geometry and scoring assumptions well enough to remain in the candidate set.",
    sections: [
      {
        heading: "What the colors mean",
        body: "Colors correspond to path-family classifications such as slow, perpendicular, mixed, and other.",
      },
      {
  ...
  "layer:debris": {
    ...
    sections: [
      { heading: "What it is", body: "This layer is descriptive. It is not the new joint inversion result by itself." },
      {
        ...
        body: "It shows where debris was found and how those finds relate broadly to plausible source regions.",
      },
    ],
  },
  "layer:holidays": {
    ...
    summary:
      "Marks areas where search coverage exists on paper but the data quality or completeness is not strong enough to treat as fully cleared with confidence.",
    sections: [
      {
        heading: "Why it matters",
        body: "A searched area is not always equivalent to a well-searched area. Data holidays capture that distinction.",
      },
      {
        heading: "How to combine it",
        body: "Compare with Priority Gaps and Searched Areas to see whether a high-interest zone may still deserve attention.",
      },
    ],
  },
  "layer:priority": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Use it with Searched Areas and optionally the heatmap, not with every analytical layer at once.",
      },
    ],
  },
  "layer:points": {
    ...
    summary:
      "Shows anchor locations such as KLIA, the last radar fix, and the satellite position so you can orient the rest of the analysis.",
    sections: [
      {
        heading: "Why it helps",
        body: "These markers keep the geometry legible when you are zoomed out or switching between evidence layers.",
      },
  ...
  "layer:searched": {
    ...
    summary:
      "Shows the approximate polygons for ATSB and Ocean Infinity search zones, used to compare model output with what has already been covered.",
    sections: [
      {
        heading: "What it means",
        body: "If a favored model zone sits inside these polygons, the case for it has to explain why the wreck was missed.",
      },
  ...
  "section:search": {
    ...
    summary:
      "This section controls the live sonar and search-coverage context layers used to compare predicted zones with where people have already looked.",
    sections: [
      {
        heading: "Opacity control",
        body: "Use sonar opacity when you want bathymetry or search swaths visible without overpowering the analytical overlays.",
      },
      {
        heading: "Best use",
        body: "Keep search coverage context visible when evaluating priority gaps or debris/satellite agreement.",
      },
    ],
  },
  "sonar:auv": {
    ...
    summary:
      "Displays live AUV sidescan sonar imagery where available, useful for examining what has already been visually scanned at high resolution.",
    sections: [
      { heading: "What you see", body: "This is a base imagery layer, not a probability result." },
      {
        heading: "Why it matters",
        body: "It helps separate genuinely new target zones from areas already seen in detail.",
      },
    ],
  },
  "sonar:deep-tow": {
    ...
    summary:
      "Shows deep tow sonar imagery from historical search campaigns, useful for contextualizing older search effort.",
    sections: [
      {
        heading: "Interpretation",
        body: "Use it to understand legacy search visibility, especially where terrain or coverage quality may have varied.",
      },
      {
        heading: "Comparison",
        body: "It complements the searched polygons by showing actual imagery where available.",
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: "Small assumption changes can move the preferred zone a long way, so this section is for sensitivity testing rather than cosmetic tuning.",
      },
      {
        heading: "Workflow",
        body: "Change one thing at a time, rerun, and compare how the preferred arc sectors move.",
      },
    ],
  },
  "config:min_speed_kts": {
    ...
    sections: [
      {
        heading: "Effect",
        body: "Lower values allow slower path families and can broaden the feasible arc intersections.",
      },
      {
        heading: "Use carefully",
        body: "Unrealistically low speeds may create paths that are mathematically possible but operationally weak.",
      },
    ],
  },
  "config:max_speed_kts": {
    ...
    sections: [
      {
        heading: "Effect",
        body: "Higher values can open faster families and shift where arcs can be crossed plausibly.",
      },
  ...
  "config:satellite_drift_amplitude_deg": {
    ...
    summary:
      "Controls the fallback sinusoidal satellite drift amplitude when operating outside the embedded ephemeris range.",
    sections: [
      {
        heading: "Current state",
        body: "Inside the ATSB ephemeris time range, the real embedded ephemeris dominates.",
      },
  ...
  "config:max_post_arc7_minutes": {
    ...
    summary:
      "Defines how long the aircraft could continue after the last handshake before fuel exhaustion in the model.",
    sections: [
  ...
  "config:debris_weight_min_lat": {
    ...
    summary:
      "Controls the lower latitude boundary for the existing debris-weight preference used in the main heatmap model.",
    sections: [
      {
        heading: "What it does",
        body: "This does not run the new inversion. It only affects the older debris-weight shaping inside the heatmap model.",
      },
      {
        heading: "When to change",
        body: "Only when comparing how strongly the main heatmap should favor a debris-consistent corridor.",
      },
    ],
  },
  "config:debris_weight_max_lat": {
    ...
    summary:
      "Controls the upper latitude boundary for the older debris-weight preference inside the main heatmap model.",
    sections: [
      {
        heading: "How to use",
        body: "Adjust with the minimum bound as a pair if you are testing debris corridor sensitivity.",
      },
      {
        heading: "Keep in mind",
        body: "This is separate from the new joint inversion result shown in the inversion section.",
      },
    ],
  },
  "action:run-model": {
    ...
    sections: [
      { heading: "What updates", body: "Candidate paths, heatmap, priority gaps, and summary displays." },
      {
        ...
        body: "Change a small number of assumptions, rerun, then compare the resulting peak zone.",
      },
    ],
  },
  "action:reset-model": {
    ...
    sections: [
      {
        heading: "Use case",
        body: "Helpful after exploratory tuning when you want to get back to the baseline model quickly.",
      },
      {
        heading: "What it does not do",
        body: "It does not automatically rerun the backend until you press Run Model.",
      },
    ],
  },
  ...
  "section:inversion": {
    ...
    summary:
      "This section runs the debris inversion and compares its preferred 7th-arc zone with the satellite-driven peak from the main model.",
    sections: [
  ...
  "inversion:result": {
    ...
    sections: [
      ...
      {
        heading: "What it does not do",
        body: "It does not override the heatmap or remove any flight solutions. It is a comparison layer.",
      },
    ],
  },
  "inversion:comparison": {
    ...
    sections: [
      {
        heading: "Colors",
        body: "Blue is satellite-led, orange is debris-led, green is the overlap/intersection zone.",
      },
  ...
  "action:run-inversion": {
    ...
    summary:
      "Runs the debris inversion on demand. In desktop mode it computes live in Rust; in browser mode it loads the precomputed snapshot result.",
    sections: [
      {
        heading: "What updates",
        body: "The inversion line, comparison overlay, summary text, and bottom-left inversion summary panel.",
      },
      {
        heading: "Caveat",
        body: "The result is only as strong as the loaded debris dataset and simplified drift assumptions.",
      },
    ],
  },
  "section:path-families": {
    ...
    summary:
      "Summarizes how the candidate path set clusters into families such as slow, perpendicular, mixed, and other.",
    sections: [
      {
        heading: "Why it matters",
        body: "Different families imply different heading and speed behavior near the last arcs.",
      },
      {
        heading: "How to use",
        body: "Turn on Candidate Paths and compare the family legend with the geometry on the map.",
      },
    ],
  },
  "section:legend": {
  ...
  "section:info": {
    ...
    summary:
      "This panel explains the philosophy of the app: uncertainty first, BTO-led geometry, and inspectable assumptions.",
    sections: [
